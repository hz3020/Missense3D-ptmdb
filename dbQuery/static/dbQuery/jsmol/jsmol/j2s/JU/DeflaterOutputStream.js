...
Clazz.load(["java.io.FilterOutputStream"], "JU.DeflaterOutputStream", null, function(){
...
this.close_out = true;
Clazz.instantialize(this, arguments);}, JU, "DeflaterOutputStream", java.io.FilterOutputStream);
Clazz.prepareFields (c$, function(){
this.buf1 =  Clazz.newByteArray (1, 0);
});
Clazz.makeConstructor(c$, 
function(){
Clazz.superConstructor(this, JU.DeflaterOutputStream, [null]);
});
