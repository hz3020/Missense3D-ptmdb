...
this.bi_valid = 0;
this.gheader = null;
Clazz.instantialize(this, arguments);}, JU, "Deflate", null);
...
this.max_chain = 0;
this.func = 0;
Clazz.instantialize(this, arguments);}, JU.Deflate, "Config", null);
Clazz.makeConstructor(c$, 
...
}c$.z_errmsg =  Clazz.newArray(-1, ["need dictionary", "stream end", "", "file error", "stream error", "data error", "insufficient memory", "buffer error", "incompatible version", ""]);
});
