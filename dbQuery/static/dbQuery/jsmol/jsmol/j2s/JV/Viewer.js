...
this.setBooleanPropertyTok("doubleprecision", 603979831, true);
});
...
this.ptNew.add(this.ms.at[iatom]);
...
function(bsAtoms, xyzList, unitCellParams, asString, isAssign, checkSupercell){
var ret = null;
if (bsAtoms == null && xyzList == null || isAssign) bsAtoms = this.getThisModelAtoms();
if (xyzList == null) {
if (!bsAtoms.isEmpty()) {
var uc = this.getCurrentUnitCell();
ret = (uc == null ? null : uc.findSpaceGroup(this, bsAtoms, null, unitCellParams, asString, isAssign, checkSupercell));
}} else {
ret = this.getSymTemp().findSpaceGroup(this, bsAtoms, xyzList, unitCellParams, asString, isAssign, checkSupercell);
...
function(bs, type){
return this.getModelkit(false).cmdAssignSpaceGroup(bs, type);
}, "JU.BS,~S");
...
;//5.0.1-v2 Mon Feb 05 09:25:56 CST 2024
