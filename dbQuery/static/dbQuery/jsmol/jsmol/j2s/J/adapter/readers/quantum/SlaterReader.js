...
this.getSlaters().addLast( new J.quantum.SlaterData(iAtom, a, b, c, d, zeta, coef));
}, "~N,~N,~N,~N,~N,~N,~N");
...
c$.fact1 =  Clazz.newDoubleArray(-1, [1.0, 2.0, 24.0, 720.0, 40320.0, 362880.0, 87178291200.0]);
