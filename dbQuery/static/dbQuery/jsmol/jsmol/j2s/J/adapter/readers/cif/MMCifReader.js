...
var groupName;
var hetName;
while (this.cifParser.getData()) if (!this.isNull(groupName = this.getFieldString(0)) && !this.isNull(hetName = this.getFieldString(1))) this.addHetero(groupName, hetName, true, true);
...
c$.chemCompFields =  Clazz.newArray(-1, ["_chem_comp_id", "_chem_comp_name"]);
...
c$.structSiteFields =  Clazz.newArray(-1, ["*_site_id", "*_auth_comp_id", "*_auth_asym_id", "*_auth_seq_id", "*_label_alt_id"]);
