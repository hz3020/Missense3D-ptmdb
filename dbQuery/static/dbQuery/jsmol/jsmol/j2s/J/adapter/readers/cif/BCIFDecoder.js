...
function(key, col, sb){
this.construct (sb, key, col, null, null);
}, "~S,java.util.Map,JU.SB");
Clazz.makeConstructor(c$, 
function(encoding, ekey, byteData, sb){
this.construct (sb, ekey, encoding, ekey, byteData);
}, "java.util.Map,~S,~O,JU.SB");
Clazz.makeConstructor(c$, 
function(sb, key, map, ekey, byteData){
this.key = key;
...
if (mask != null) {
this.maskDecoder =  new J.adapter.readers.cif.BCIFDecoder(mask, null, null, sb);
...
this.dataDecoder =  new J.adapter.readers.cif.BCIFDecoder(encoding, "dataEncoding", this.byteData, sb);
this.offsetDecoder =  new J.adapter.readers.cif.BCIFDecoder(encoding, "offsetEncoding", encoding.get("offsets"), sb);
continue;
}
if (this.srcType == 0) {
