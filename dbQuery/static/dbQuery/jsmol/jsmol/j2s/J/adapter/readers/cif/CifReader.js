...
wyckoff = field;
seqID = ((field.length > 0 ? field.charAt(0) : 0)).charCodeAt(0);
}break;
case 13:
haveAuth = true;
...
case 61:
if (this.modulated) siteMult = this.parseIntStr(field);
break;
case 62:
case 47:
