...
Clazz.load(["J.api.JmolAdapter"], "J.adapter.smarter.SmarterJmolAdapter", ["JU.PT", "$.Rdr", "J.adapter.smarter.AtomIterator", "$.AtomSetCollection", "$.BondIterator", "$.Resolver", "$.StructureIterator", "J.api.Interface", "JS.SV", "JU.BSUtil", "$.Logger"], function(){
