...
Clazz.load(["J.adapter.readers.xml.XmlReader", "J.adapter.smarter.Atom", "$.Bond", "java.util.ArrayList", "$.HashMap", "$.Stack"], "J.adapter.readers.xml.XmlCdxReader", ["JU.BS", "$.Lst", "$.PT", "J.api.JmolAdapter", "JU.Edge", "$.Logger"], function(){
