...
Clazz.load(["java.util.zip.DeflaterOutputStream", "$.ZipConstants", "java.util.ArrayList", "$.Hashtable", "java.util.zip.CRC32"], "java.util.zip.ZipOutputStream", ["com.jcraft.jzlib.ZStream", "java.util.zip.Deflater"], function(){
...
this.finished = false;
this.$closed = false;
Clazz.instantialize(this, arguments);}, java.util.zip, "ZipOutputStream", java.util.zip.DeflaterOutputStream, java.util.zip.ZipConstants);
