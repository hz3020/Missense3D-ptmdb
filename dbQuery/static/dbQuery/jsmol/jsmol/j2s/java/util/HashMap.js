...
var key = null;
var value = null;
if (java.util.HashMap.秘isSimple(this) && java.util.HashMap.秘isSimple(mOriginal)) {
var me = this;
var hash = 0;
var mode = java.util.HashMap.秘hasKey(me, key);
{
mOriginal.秘m.forEach(function(value, key) {
me.putJSVal(hash, key, value, false, evict, mode);
});
}return;
}if (java.util.HashMap.秘isSimple(mOriginal)) {
var me = this;
{
mOriginal.秘m.forEach(function(value, key) {
...
function(){
this.modCount++;
if (java.util.HashMap.秘isSimple(this)) {
{
this.秘m.clear();
}}this.秘setJS();
...
function(key){
switch (java.util.HashMap.秘hasKey(this, key)) {
case 0:
break;
case 1:
java.util.HashMap.秘ensureJavaMap(this);
break;
case 2:
return false;
case 3:
...
function(key, value){
var type = java.util.HashMap.秘hasKey(this, key);
switch (type) {
case 0:
break;
case 1:
...
function(){
if (this.秘allowJS && java.util.HashMap.USE_SIMPLE) {
var m = null;
{
m = new Map();
}this.秘m = m;
...
Clazz.overrideMethod(c$, "get", 
function(entry){
if (java.util.HashMap.秘isSimple(this.b$["java.util.HashMap"])) {
{
...
this.isSimple = java.util.HashMap.秘isSimple(this.associatedMap);
if (this.isSimple) {
var m = this.associatedMap.秘m;
{
...
if (java.util.HashMap.秘isSimple(this.associatedMap)) {
...
Clazz.overrideMethod(c$, "get", 
function(entry){
if (java.util.HashMap.秘isSimple(this.b$["java.util.HashMap.HashMapEntrySet"].associatedMap)) {
var key = null;
var value = null;
{
key = entry.value[0];
