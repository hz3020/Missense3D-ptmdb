...
Clazz.defineMethod(c$, "setIntlTableNumberFull", 
function(name){
...
c$.getSpaceGroupFromITAName = Clazz.defineMethod(c$, "getSpaceGroupFromITAName", 
function(ita){
JS.SpaceGroup.getSpaceGroups();
