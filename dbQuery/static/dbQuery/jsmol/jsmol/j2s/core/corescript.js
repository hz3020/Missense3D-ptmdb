...
this.setBraceCount = 0;
break;
}if (this.theTok != 1073741824 && this.theTok != 268442114 && this.theTok != 12290 && (!JS.T.tokAttr(this.theTok, 536870912))) {
...
if (haveError) this.resumeViewer("exception");
...
if (uc == null) {
uc = this.vwr.getSymTemp().setUnitCell(null, false, NaN);
...
;//5.0.1-v2 Mon Feb 05 18:09:34 CST 2024
Clazz_declarePackage("JS");
...
break;
case 1086324754:
iv = (atom.getWyckoffPosition().charAt(0)).charCodeAt(0);
switch (iv) {
case 63:
iv = 0;
break;
...
while (this.oPt >= 0 && tok0 != 268436482 && (op.tok != 268441601 && op.tok != 268441602 || this.wasX) && (!isLeftOp || tok0 == 268442113 && (op.tok == 268442113 || op.tok == 268437504)) && JS.T.getPrecedence(tok0) >= JS.T.getPrecedence(op.tok) && (tok0 != 268441600 || op.tok != 268441600)) {
...
;//5.0.1-v2 Mon Feb 05 08:46:23 CST 2024
Clazz_declarePackage("JS");
Clazz_load(["JS.ScriptError"], "JS.ScriptParam", ["java.util.Hashtable", "JU.BS", "$.CU", "$.Lst", "$.Measure", "$.P3", "$.P4", "$.PT", "$.Quat", "$.SB", "$.V3", "JM.TickInfo", "JS.SV", "$.T", "JU.BSUtil", "$.Edge", "$.Escape", "$.Logger"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.contextVariables = null;
