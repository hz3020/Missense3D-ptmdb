...
class Spagetti:
    def __init__(self, residue, position, color):
...
class SpagettiList:
    ...
    def add_spagetti(self, residue, position, color):
        spagetti = Spagetti(residue, position, color)
